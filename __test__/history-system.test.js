...
describe("HistorySystem", () => {
    ...
    describe("Construction", () => {
        test("Should throw an error when capacity is not defined, finite integer", () => {
            ...
            expect(() => new HistorySystem([])).toThrow(
                "Capacity must be a finite integer number",
            );
        ...
        test("Should throw an error when capacity is not between 1 and 64", () => {
            expect(() => new HistorySystem(-20)).toThrow(
                "Capacity must be between 1 and 64 inclusive",
            );
    ...
    describe("Functionality", () => {
        ...
        beforeEach(() => {
            assertGroup = function(
                ...
                if (expectedData !== null) {
                    expect(hs.getActionData(offset)).toEqual(expectedData);
        ...
        describe("Getting size and capacity", () => {
            test("Should throw an exception if offset is not a finite integer", () => {
                ...
                toTest(-10);
                toTest(100);
                toTest("a", "Offset must be a finite integer number");
                toTest("aah", "Offset must be a finite integer number");
                toTest(["aah"], "Offset must be a finite integer number");
                toTest([3], "Offset must be a finite integer number");
                toTest(
                    { a: 3, b: 4 },
                    "Offset must be a finite integer number",
                );
            });
        });
