...
export default class LayerManager {
     ...
     */
    darkBG = Color.get({ rgb: [160, 160, 160], alpha: 1 });
    lightBG = Color.get({ rgb: [217, 217, 217], alpha: 1 });
    /**
    ...
    getColor(x, y) {
        ...
        if (this.renderCache.has({ x, y }))
            return this.renderCache.get({ x, y });
